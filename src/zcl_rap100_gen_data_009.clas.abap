"! This class is used to fill travel data into the table zrap100_atrav009
CLASS zcl_rap100_gen_data_009 DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_009 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '009',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav009.
*    DELETE FROM zrap100_dtrav009.

    "insert travel demo data
    INSERT zrap100_atrav009  FROM (
        SELECT
